...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: `${siteConfig.businessName} | ${siteConfig.primaryCity} HVAC Repair, Install & Service` },
      ...
      { property: "og:title", content: `${siteConfig.businessName} | ${siteConfig.primaryCity} HVAC` },
