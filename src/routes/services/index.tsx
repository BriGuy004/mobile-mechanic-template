    ...
    <>
      <section className="bg-brand-light border-b border-slate-200">
        <div className="mx-auto max-w-7xl px-6 py-12 md:py-16">
          <div className="text-xs font-bold uppercase tracking-wider text-brand-accent mb-2">{t("nav.services")}</div>
      ...
      <section className="bg-white py-12 md:py-16">
        <div className="mx-auto max-w-7xl px-6 space-y-12">
          {cats.map((cat) => {
            ...
            return (
              <div key={cat}>
                <h2 className="text-2xl font-bold mb-5 capitalize">{t(`services.categories.${cat}`)}</h2>
